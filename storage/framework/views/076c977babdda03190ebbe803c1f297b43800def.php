...
<?php $__env->startSection('main'); ?>
    <div class="page-header-fullwidth js-page-header-fullwidth page-header-padding">
        <div class="container"><h4 class="submit-header h4">Add a store !</h4></div>
    </div>
    ...
    <div class="container js-page-container ">
        <div class="offer-submission">
            <div class=" submit-coupon form section-padding js-no-redirect" data-sitekey="6LemcCQTAAAAABsVoXnN0PsSkfUEFRvTqMZGqCLm">
                <form method="post" action="<?php echo e(url('dashboard/store/add')); ?>" id="couponSubmit" name="couponsubmit" class="submit-coupon-form js-submit-coupon-form" autocomplete="off" novalidate="" enctype="multipart/form-data">
                    ...
                    <fieldset>
                        <div class="field-container">
                            ...
                            <input type="text" id="domain" class="ui-autocomplete-input domain" autocomplete="off" name="name" value="" placeholder="e.g., Amazon"> </div>
                    </fieldset>

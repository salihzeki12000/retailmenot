                                ...
                                <form class="js-auth-form" method="post" action="<?php echo e(url('register')); ?>" data-auth-action="signup" novalidate="">
                                    ...
                                    <fieldset class="login-signup-form-fields">
                                        ...
                                        <div class="field-container grid-unit">
                                            <input class="submit-required blur signup-email" type="email" value="<?php echo e(old('email')); ?>" placeholder="Email" name="email">
                                        </div>
                                        ...
                                        <!--[if lte IE 9]><label for="password_confirmation">Confirm Password</label><![endif]-->
                                                ...
                                                <?php if($errors->has('password_confirmation')): ?>
                                                    <div class="input-error password-msg"><?php echo e($errors->first('password_confirmation')); ?></div>
                                            <?php endif; ?>

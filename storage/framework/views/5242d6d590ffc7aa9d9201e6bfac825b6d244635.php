    ...
    <div class="container js-page-container ">
        <div class="offer-submission">
            <div class=" submit-coupon form section-padding js-no-redirect" data-sitekey="6LemcCQTAAAAABsVoXnN0PsSkfUEFRvTqMZGqCLm">
                <form method="post" action="<?php echo e(url('dashboard/store/edit/' . $store->id)); ?>" id="couponSubmit" name="couponsubmit" class="submit-coupon-form js-submit-coupon-form" autocomplete="off" novalidate="" enctype="multipart/form-data">
                    ...
                    <fieldset>
                        <div class="field-container">
                            ...
                            <input type="text" id="domain" class="ui-autocomplete-input domain" autocomplete="off" name="name" value="<?php echo e($store->name); ?>" placeholder="e.g., Amazon"> </div>
                    </fieldset>
                    ...
                    <img src="<?php echo e(url('public/image/' . $store->img)); ?>" width="50%">

...
<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# retailmenot: http://ogp.me/ns/fb/retailmenot#">
    ...
    <!--[if gt IE 9]><!-->
    <script type="text/javascript" src="<?php echo e(url('public/js/d1.js')); ?>" defer></script>
    <script type="text/javascript" src="<?php echo e(url('public/js/d2.js')); ?>" defer></script>
    <!--<![endif]-->
                ...
                <ul class="site-nav-list">
                    <li class="site-nav-item js-mobile-user-bar-avatar ">
                        <a class="site-nav-link" href="https://cdn1.iconfinder.com/data/icons/freeline/32/account_friend_human_man_member_person_profile_user_users-256.png">
                            ...
                            <span class="avatar-name js-username"><?php echo e(Auth::user()->email); ?></span>
                        </a>
                    </li>
                                    ...
                                    <div class="popup-menu js-popup-menu">
                                        <div class="popup-trigger js-popup-toggle has-avatar">
                                            ...
                                            <a class="popup-title js-popup-title" href="">
                                                <img class="avatar avatar--tiny js-avatar" src="https://cdn1.iconfinder.com/data/icons/freeline/32/account_friend_human_man_member_person_profile_user_users-256.png" alt="avatar image" /> <span class="avatar-name js-username"><?php echo e(Auth::user()->email); ?></span>
                                                <svg class="icon icon-arrow-down">
                                                    <use xlink:href="#icon-arrow-down"></use>
                                                </svg>
                                            </a>
                                            ...
                                            <ul class="popup-menu-list">
                                                ...
                                                <li class="popup-menu-item">
                                                    <a class="popup-menu-link" href="<?php echo e(url('logout')); ?>">Log out</a>
                                                </li>
                                            </ul>

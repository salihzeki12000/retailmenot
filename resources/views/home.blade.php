...
@section('main')
                ...
                @foreach(\App\Header::all() as $item)
                    ...
                    <div class="carousel-slide js-carousel-slide js-triggers-outclick" data-offer-id="9020444" data-offer-uuid="IX3DJUU7FBHAXC4XZWIJMCAT7Y" data-merchant-url="/out/S142035" data-offer-type="code" data-type="code" data-out-url="/out/9020444" data-merchant-name="expedia.com" data-site-title="Expedia" data-site-id="142035" data-site-uuid="" data-couponscore="19" data-couponrank="-11.11" data-comment-count="" data-has-submitter="false" data-analytics-click-location="offer body" data-adunit="LGG5EGPEWCIBQVFWKT4QAAAAAA" data-main-tab="/out/9020444" data-new-tab="/?c&#x3D;9020444" data-impression-pixel="" data-click-pixel="">
                        <a href="">
                            ...
                            <img src="{{ url('public/image/' . \App\Store::findOrFail($coupon->store_id)->img  )}}" alt="" />
                            <div class="carousel-slide-content">
                                <div class="carousel-slide-media">
                                    <img src="{{ url('public/image/' . \App\Store::findOrFail($coupon->store_id)->img  )}}" alt="Expedia" />
                                </div>
                                <div class="carousel-slide-text-wrapper">
                                    <h3 class="carousel-slide-title"> {{ \App\Coupon::findOrFail($item->coupon_id)->description }} </h3>
                                    <p class="carousel-slide-text">{{ \App\Coupon::findOrFail($item->coupon_id)->link }} </p>
                                </div>
                            </div>
                        </a>
                    </div>
                                ...
                                <div class="offer-item-main">
                                    ...
                                    <div class="offer-item-body">
                                        <div class="offer-item-body-content">
                                            <div class="offer-item-title"><a href="/out/9022233" class="offer-item-title-link js-triggers-outclick" data-analytics-click-location="OfferTitle">{{ $item->description }}</a></div>
                                            <div class="offer-item-info">
                                                <div class="offer-meta offer-meta-promoted has-separator-dot">Sponsored</div>
                                            </div>
                                        </div>
                                        <div class="offer-item-actions btn-open-modal-{{ $item->id }}">
                                            <a class="button-show-code offer-button " data-analytics-click-location="OfferCode" data-revealed-code="IT">Show Code</a>
                                        </div>

                                        <script>
                                            $('.btn-open-modal-{{ $item->id }}').click(function(){

                                                $('.modal-active-{{ $item->id }}').css("display", "block");
                                ...
                                <div class="js-offer-item-tabs offer-item-tabs hidden">
                                    <div class="offer-item-tabs-header">
                                        <ul class="offer-item-tabs-header-list">
                                            <li class="js-tabs-header-item offer-item-tabs-header-item " data-tab-key="0" data-tab-id="tab-{{ $item->id }}-details"><a class="js-tabs-header-item-link offer-item-tabs-header-item-link " data-prompt-name="offer details">Details</a></li>
                                            <li class="js-tabs-header-item offer-item-tabs-header-item js-comments-tab" data-tab-key="1" data-tab-id="tab-{{ $item->id }}-comments"><a class="js-tabs-header-item-link offer-item-tabs-header-item-link js-comment-count" data-prompt-name="add a comment">Add a Comment</a></li>
                                        </ul>
                                    ...
                                    <div class="offer-item-tabs-content">
                                        <div id="tab-{{ $item->id }}-details" class="offer-item-tabs-content-item js-tabs-content-item offer-item-tabs-content-details" data-tab-key="0">
                                            <p><strong>Expires:</strong> {{ $item->exp_date }}</p>
                                            <p><strong>Details:</strong>&nbsp;{{ $item->description }}</p>
                                        </div>
                                        <div id="tab-{{ $item->id }}-comments" class="offer-item-tabs-content-item js-tabs-content-item offer-item-tabs-content-feedback" data-tab-key="1">
    ...
    @foreach(\App\Coupon::all() as $item)
    <div id="modal" class="modal fade in modal-active-{{ $item->id }}" role="dialog" aria-hidden="false" style="display: none;">
        <div class="js-modal-inner modal-dialog coupon-modal" id="couponModal">
            <div class="modal-content">
                <div class="modal-header">
                    <span class="modal-close js-close close-btn-{{ $item->id }}" data-dismiss="modal" aria-label="Close">
                            ...
                            <div class="offer-redemption-wrapper show-coupon-redemption js-redemption-offer js-offer" data-offer-id="9042011" data-offer-uuid="ZHDL6J5PCJAFTLFZV72QJDVN6Y" data-merchant-url="/out/S151300" data-offer-type="code" data-type="code" data-out-url="/out/9042011" data-merchant-name="michaels.com" data-site-title="Michaels" data-site-id="151300" data-site-uuid="KNPXMJLLVVFZRJXM2XJIJ4VYTM" data-couponscore="" data-couponrank="0.70" data-comment-count="4" data-has-submitter="false" data-analytics-click-location="offer body" data-main-tab="/out/9042011" data-new-tab="/?c=9042011" data-mode="">
                                <div class="offer-redemption-content">
                                    <a href="" class="offer-merchant-logo js-offer-logo" target="">
                                        <img src="{{ url('public/image/' . \App\Store::findOrFail($item->store_id)->img )}}" alt="Michaels" data-offer-id="9042011" data-offer-uuid="ZHDL6J5PCJAFTLFZV72QJDVN6Y" data-merchant-url="/out/S151300" data-offer-type="code" data-type="code" data-out-url="/out/9042011" data-merchant-name="michaels.com" data-site-title="Michaels" data-site-id="151300" data-site-uuid="KNPXMJLLVVFZRJXM2XJIJ4VYTM" data-couponscore="" data-couponrank="0.70" data-comment-count="4" data-has-submitter="false" data-analytics-click-location="offer body" data-main-tab="/out/9042011" data-new-tab="/?c=9042011" data-mode=""> </a>
                                    <h3 class="offer-title">	{{ $item->description }}	</h3> </div>
                                <div class="offer-redemption-block">
                                    <div class="offer-code">
                                        ...
                                        <p class="offer-tip">Copy and paste this code at <a class="js-merchant-link" href="{{ $item->link }}" target="_blank" rel="nofollow">{{ $item->link }}</a></p>
                                        <div class="code-attached-copy">
                                            <div class="button-code js-selectcode">{{ $item->code }}</div>
                                ...
                                <div class="offer-detail-information">
                                    ...
                                    <div class="offer-details exclusions description-wrapper js-desc js-toggle">
                                        ...
                                        <p class="offer-details-info js-description-text">{{ $item->exp_date }}</p>
                                    </div>
                                    <div class="offer-details details description-wrapper js-desc js-toggle">
                                        <p class="offer-details-header">Details</p>
                                        <p class="offer-details-info js-description-text">{{ $item->description }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        $('.close-btn-{{ $item->id }}').click(function(){

            $('.modal-active-{{ $item->id }}').css("display", "none");

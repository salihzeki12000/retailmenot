                    ...
                    <section class="section-padding js-login-ui js-tabs">
                        ...
                        <div class="tabs-content">
                            <div id="signIn" class="tabs-content-item js-tabs-content-item active">
                                ...
                                <p>Haven't an account? <a href="{{ url('signup') }}" >Signup</a></p>
                                <form class="js-auth-form" data-auth-action="login" method="post" action="{{ url('login') }}" novalidate="">
                                    ...
                                    <fieldset class="login-signup-form-fields">
                                        ...
                                        <div class="field-container grid-unit">
                                            <input class="submit-required blur signup-email" value="{{ old('email') }}" type="email" placeholder="Email" name="email">
                                        </div>
